...
const svg = `<svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="140" y="142" font-family="Courier New, monospace" font-size="40" letter-spacing="8" fill="#00d2aa">ДИЗЕЛЬ МОНІТОР <tspan fill="#6d8f86">UA</tspan></text>
  ...
  <text x="110" y="370" font-family="Courier New, monospace" font-size="26" fill="#6d8f86">дизель · бензин · автогаз — 36 мереж АЗС, 23 області</text>
